...
export default class Section extends THREE.Group {
    ...
    constructor( opts = { timeline, section } ) {
        ...
        else if( this.section === 'dec' ) this.createNextection()
        else if( this.section === 'end' ) this.createEndSection()
        else if( this.section === 'contact' ) this.createNextection() //this.createContactSection()
        else this.create()
    ...
    createNextection() {
        let string = `<div><h1>Contact  Element.</h1>
